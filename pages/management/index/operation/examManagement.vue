            ...
            <div class="left_area">
              <div class="dropdown form-inline">
                ...
                <div class="dropdown-menu">
                  <a class="dropdown-item cursor" @click="onChangeSort">전체</a>
                  <a class="dropdown-item cursor" @click="onChangeSort"
                    >레슨 높은 순</a
                  >
                  <a class="dropdown-item cursor" @click="onChangeSort"
                    >레슨 낮은 순</a
  ...
  methods: {
    ...
    onSettingClassAnswer(answer, id, idx) {
      ...
      if (answer === id) {
        ...
        this.selectedExamInfo.examResult[idx].check !== id &&
        id !== answer
        // this.selectedExamInfo.examResult[Math.ceil(selectedExamInfo.examResult.length / 2
        // ) + idx].check !== id &&
        // id !== answer
      ) {
        result = ''
    ...
    setFilterDificultade(dificultade) {
      let result = ''
      switch (dificultade) {
        case 0:
          result = '하'
