				...
				<div class="tab-pane active">
					...
					<div class="search_section">
						<div class="left_area">
							...
							<button class="btn btn_crud_default" @click="pasteData">붙여넣기</button>
...
export default {
  ...
  mounted() {
    ...
    if(this.identity==='master'){
      this.institutionData=new Tree(false,dataMapping(this.receiveInstitutionData,false))
      this.franchiseData=new Tree(false,dataMapping(this.receiveFranchiseData,false))
    }else{
      this.institutionData=new Tree(true,dataMapping(this.receiveInstitutionData,true))
      this.franchiseData=new Tree(true,dataMapping(this.receiveFranchiseData,true))
    }
    this.myCurriculumData=new Tree(false,dataMapping(this.receiveCurriculumData,false))
  },
  methods: {
    onDel(node) {
      console.log(node)
