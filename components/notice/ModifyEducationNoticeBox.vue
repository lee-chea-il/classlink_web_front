<template>
  <div class="tab-pane active">
        ...
        <div class="target_area">
          ...
          <span class="box02">
            <span class="content02">
              ...
              >
                {{ item }}
                <span v-if="syncNoticeList.targetSetting.length - 1 !== idx"
                  >|</span
                >
              </span>
            </span>
    ...
    />
    <div class="btn_area">
      <button class="btn btn_crud_point" @click="$emit('modify-notice')">
        등록
      </button>
      <NuxtLink to="/management/notice/education" class="btn btn_crud_default"
        >취소</NuxtLink
      >
    </div>
  </div>
