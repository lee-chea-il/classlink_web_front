...
<template>
	<div>
		...
		<Meta name="description" content="교육특화 메타버스 클래스링크 가상공간의 또 다른 학교
		오프라인 학교/학원보다 더 학교/학원같은 캠퍼스" />
		<Link rel="canonical" href="https://www.metaclasslink.com" />
		<Meta property="og:title" content="클래스링크 | CLASS LINK" />
		<Meta property="og:description" content="교육특화 메타버스 클래스링크
		가상공간의 또 다른 학교
		오프라인 학교/학원보다 더 학교/학원같은 캠퍼스" />
		<Meta property="og:url" content="https://www.metaclasslink.com" />
		<Meta property="og:site_name" content="CLASS LINK" />
		<Meta property="og:type" content="website" />
		<Meta property="og:image" content="../images/opengraph.png"/>
		<Meta name="google-site-verification" content="6SXBtHuUik4iemdPnrwQqnALxTYEgqp9LWdjWhionqM" />
		<Meta name="twitter:card" content="summary_large_image" />
		<Meta name="twitter:title" content="클래스링크 | CLASS LINK" />
		<Meta name="twitter:description" content="교육특화 메타버스 클래스링크
		가상공간의 또 다른 학교
		오프라인 학교/학원보다 더 학교/학원같은 캠퍼스" />
		...
		<Link rel="stylesheet" href="assets/css/incommon.css" />
		<div id="header" class="header">
			...
			<div class="nav_web">
				<div class="nav_top_wrap">
					<div class="nav_top">
						<div class="logo_area">
							<a><img src="assets/images/ClassLink_logo.svg" alt="ClassLink" /></a>
						</div>
						<div class="nav_area">
							<ul class="nav nav_dapth01 justify-content-center">
								<li class="nav-item">
									<a class="nav-link active" href="#">수업 준비</a>
								</li>
								<li class="nav-item">
				...
				<div class="nav_top_wrap">
					<div class="nav_top">
						<div class="mobile_navbtn_area left">
							<button id="mobilebackBtn" class="btn icons_arrow2_l" onclick="history.back();"></button>
						</div>
						<div class="title_area" style="color: #2C51D7;">마이홈</div>
			...
			<div id="alertPops" class="alert_pops">
				...
				<div class="cnts">
					...
					<div class="alert_box">
						<div class="tit_area">
							...
							<span class="tit">알림제목알림제목알림제목알림제목알림제목알림제목알림제목알림제목</span>
						</div>
						<div class="info_area">
							<div class="teacher">
								<span class="cat">영어</span>
								<span class="cat">영어리딩심화글이넘치네요</span>
								<span class="cat">심화A반글이넘치네요</span><span class="cat">홍길동 선생님</span>
							</div>
				...
				<a href="javascript:;" class="btn_area close_alert" data-toggle="modal" data-target="#modalAlertclasslink">
					<i class="icons_plus_circle"></i> 알림 더보기
				</a>
			</div>

			<!-- 클래스링크 알림 모달 팝업 -->
			<div class="modal fade" id="modalAlertclasslink" tabindex="-1" aria-labelledby="modalAlertclasslink" aria-hidden="true">
				<div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" id="modalAlertclasslink">클래스링크 알림</h5>
