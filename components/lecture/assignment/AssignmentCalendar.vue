    ...
    <div class="calendar_type02">
      ...
      <div class="calendar">
        <div class="move_calendar">
          <i class="icons_arrow_square_l cur_p" @click="prevMonth"></i>
          <span class="date_info">{{
            `${currentYear}년 ${currentMonth}월`
          }}</span>
          <i class="icons_arrow_square_r cur_p" @click="nextMonth"></i>
        </div>
...
export default {
  ...
  methods: {
    ...
    setMonthInfo() {
      ...
      this.$refs.assignmentDragArea.update(
        this.monthStartIdx,
        this.monthLastIdx
      )
    },
    getData(day) {
      ...
      if (this.lectureData[cDay] === undefined)
        this.lectureData[cDay] = { data: [], linkIdx: -1 }
