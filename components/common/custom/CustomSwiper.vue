<template>
  <swiper
    :class="
      isHorizontal
        ? 'swiper swiper_horizontal lecture'
        : 'swiper swiper_vertical'
    "
  ...
  >
    ...
    >
      <div
        v-if="!isHorizontal"
        class="study_box cursor"
        @click="$emit('click-lecture', 0)"
      >
        ...
        <div class="lesson">
          ...
          ><span class="divid"></span> <span>{{ data.lessonClass }}</span
          ><br />
          <span class="teacher">{{ data.teacher }}</span>
        </div>
      </div>

      <div v-else class="study_box cursor" @click="$emit('click-lecture', 0)">
        <div class="box">
          <div class="subject">{{ data.subject }}</div>
          <div class="time">{{ data.time }}</div>
          <div class="lesson">
