<template>
	<div id="modalLectureRegi04" class="modal fade modal_ac_manage_lec" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered modal-xl">
			<div class="modal-content">
											...
											<ul>
												<li>
													...
													<div id="list_sub01" class="list_sub">
														<ul>
															<li>
																<i id="show_sublist01_sub" class="btn icons_arrow_r"></i>
											...
											<tbody>
												<tr class="week first">
													...
													<td class="calendar-day">
														...
														<!-- 3개초과 개수 표시 -->
														<button class="btn over_num" data-toggle="modal" data-target="#modalLectureRegi05">+3</button>
														<!-- 커리큘럼 Box -->
														<div class="curi_box">
															<span class="tit">소단원소단원1소단원1소단원1</span>
															<button class="btn icons_minus_circle_alph btn_del"></button>
														</div>
														<!-- 커리큘럼 Box -->
														<div class="curi_box">
															<span class="tit">소단원소단원1소단원1소단원1</span>
				...
				<div class="modal-footer">
					<button class="btn btn_crud_default" data-dismiss="modal" data-toggle="modal" data-target="#modalLectureRegi03">이전</button>
