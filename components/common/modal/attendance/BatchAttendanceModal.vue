    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h5 id="exampleModalLabel" class="modal-title">일괄 출결</h5>
          <button
            type="button"
            class="close"
            data-dismiss="modal"
          ...
          <div class="modal_batchattendance">
            <div class="date_area">
              ...
              <div class="dropdown form-inline">
                <select class="btn dropdown-toggle">
                  <option value="" class="dropdown-item">오후 4:48</option>
                  <option value="" class="dropdown-item">00:00</option>
                  <option value="" class="dropdown-item">00:00</option>
                  <option value="" class="dropdown-item">00:00</option>
                </select>
                <!-- <button
            ...
            <div class="cnts_section">
              <div class="list_section">
                ...
                <div class="list_area">
                  <ul>
                    <li>
                      ...
                      <div class="times">오후 4:48 하원</div>
                    </li>
                    <li>
                      <div class="custom-control custom-checkbox form-inline">
                        <input
                ...
                <div class="btn_area">
                  <button class="btn btn_crud_default">등원하기</button>
                </div>
              </div>
              ...
              <div class="list_section">
                ...
                <div class="list_area">
                  <ul>
                    <li>
                      ...
                      <div class="times">오후 4:48 등원</div>
                    </li>
                    <li>
                      <div class="custom-control custom-checkbox form-inline">
                        <input
                ...
                <div class="btn_area">
                  <!-- 비활성 : disabled -->
                  <button class="btn btn_crud_default disabled">
                    하원하기
                  </button>
                </div>
              </div>
