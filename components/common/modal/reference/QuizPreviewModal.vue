...
import LeftSection from '~/components/reference/quizPreview/PreviewLeftSection.vue'
import RightSection from '~/components/reference/quizPreview/PreviewRightSection.vue'
