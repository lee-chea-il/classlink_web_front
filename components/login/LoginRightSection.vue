    ...
    <div id="loginRwrap" class="wrap">
      ...
      <div class="form_section">
        ...
        >
          ...
          <button type="submit" class="btn btn_crud_point">로그인</button>
...
import CustomTextPw from "@/components/common/custom/CustomTextPw.vue";
...
function onSubmit(data) {
  if (isClickable) {
    ...
    const response = apiLogin.checkLogin(loginData);
    response.then((res) => {
