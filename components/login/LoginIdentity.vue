  ...
  <div class="right_section">
    <div id="loginRwrap" class="wrap">
      ...
      <div class="status_section">
        <CustomIdentityBtn
          :datas="identityDatas[0]"
          @toggle-radiobox="tooggleRadioBox"
        />
        <CustomIdentityBtn
          :datas="identityDatas[1]"
          @toggle-radiobox="tooggleRadioBox"
        />
        <CustomIdentityBtn
          :datas="identityDatas[2]"
          @toggle-radiobox="tooggleRadioBox"
        />
        <CustomIdentityBtn
          :datas="identityDatas[3]"
          @toggle-radiobox="tooggleRadioBox"
        />
      </div>
...
const identityDatas = ref([
  ...
  },
  {
    ...
    checked: false,
    id: "radio_1",
    class: "btn_status_franchise_director",
  },
  {
    title: "선생님",
    checked: false,
    id: "radio_2",
    class: "btn_status_teacher",
  },
  {
    title: "프랜차이즈 관리자",
    checked: false,
    id: "radio_3",
    class: "btn_status_franchise_administrator",
  },
]);
const nextBtnEvent = () => {
